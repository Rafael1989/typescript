...
// void
function alerta() {
    //... alert('Operação não permitida'); NÃO RETORNA NADA VOID
}
// null e undefined -> Não faz muito sentido!
var u = undefined;
var n = null;
// null e undefined são subtipos dos outros tipos DÁ PARA ATRIBUIR UNDEFINED E NULL NOS OUTROS TIPOS COMO STRING, NUMBER ETC...
nome = undefined;
nome = null;
